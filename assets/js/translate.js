...
const translationsList = [
  ...
  { key: "key_90", fr: "Réalisation d’une nouvelle gamme de produits Kleenex et campagne complète sur deux périodes différentes de l’année et vers ou à destination de deux publics cibles très différents: une gamme pour la rentrée destinée aux enfants et une gamme été familiale qui parle à petits et grands. Ce projet a été présenté devant un jury professionnel dans le cadre de ma scolarité à Garti.", en: "Development of a new range of Kleenex products and a complete campaign for two different periods of the year and two distinct target audiences: a back-to-school range for children and a summer family range appealing to both young and old. This project was presented before a professional jury as part of my studies at Garti."},
