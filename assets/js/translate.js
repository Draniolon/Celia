...
const translationsList = [
  ...
  { key: "key_15", fr: "Histoire melant deux temps de recit. D'un cote, nous explorons la creation du monde selon Jeremy Drava, a travers des figures emblematiques de la serie The Legend of Zelda delaissée par les jeux, afin d'expliquer la chronologie sous le prisme de ces personnages oublies. Dans un second temps, on accompagne ce meme Jeremy dans son quotidien chez Nintendo, qui lutte entre sa vision personnelle de l'univers et celle de sa hierarchie, alors qu'il est nomme co-auteur pour le scenario du jeu \"Zelda : Tears of the Kingdom\".", en: "Story mixing two timelines. On one side, we explore the creation of the world according to Jeremy Drava, through emblematic figures from the The Legend of Zelda series left out by the games, to explain the chronology through the lens of these forgotten characters. On the other, we follow Jeremy in his daily life at Nintendo, struggling between his personal vision of the universe and that of his hierarchy, as he is appointed co-author for the scenario of 'Zelda: Tears of the Kingdom'." },
  ...
  { key: "key_27", fr: "CÉLIA PÉTILLION", en: "CÉLIA PÉTILLION" },
  { key: "key_28", fr: "Edition", en: "Editorial Assistant" },
  { key: "key_29", fr: "Graphiste", en: "Graphic Designer" },
  { key: "key_30", fr: "Curriculum Vitae", en: "Resume" },
  { key: "key_31", fr: "Portfolio", en: "Portfolio" },
  { key: "key_32", fr: "LinkedIn", en: "LinkedIn" },
  { key: "key_33", fr: "Animée depuis toujours par une passion pour le dessin et la littérature, je suis à la recherche d'une alternance d’une durée d’un an, au rythme de 3 semaines en entreprise et 1 semaine à l'école.", en: "Driven by a lifelong passion for drawing and literature, I am looking for a one-year apprenticeship with a schedule of 3 weeks in a company and 1 week at school." },
  ...
  { key: "key_50", fr: "Bac Littéraire", en: "A-levels in Literature" },
  { key: "key_51", fr: "Option Arts Plastiques", en: "Art class option" },
  ...
  { key: "key_57", fr: "École supérieure de graphisme", en: "Superior degree in Graphical Design" },
  { key: "key_58", fr: "RECOMMANDATIONS", en: "RECOMMENDATIONS" },
  { key: "key_59", fr: "Cliente freelance", en: "Freelance client" },
  { key: "key_60", fr: "Stage", en: "Internship in City Hall" },
  { key: "key_61", fr: "Mes recommandations", en: "Referals" },
  ...
  { key: "key_84", fr: "Invention d'un personnage-objet.", en: "Inventing a character-object." },
  { key: "key_85", fr: "Smile", en: "Smile" },
  { key: "key_86", fr: "Création d’une marque fille de cannettes issue de la marque mère Smile, création d’une charte graphique et conception de différents modèles de cannette autour de parfums : deux canettes de la gamme permanente et une édition collector à l’aide de Photoshop, Illustrator, Krita et InDesign.", en: "Creation of a sub-brand of cans derived from the parent brand Smile, development of a graphic template, and design of various can models based on different flavors: two cans for the permanent range and a collector’s edition using Photoshop, Illustrator, Krita, and InDesign." },
  { key: "key_87", fr: "L'échappée Gourmande", en: "The Gourmet’s Evasion" },
  { key: "key_88", fr: "Réalisation d’une charte graphique complète avec affiches, post sur les réseaux sociaux et mise en situation des produits en moins de deux jours.", en: "Challenge to create a complete graphic charter including posters, social media posts, and product mock-ups in less than two days."},
  { key: "key_89", fr: "Kleneex", en: "Kleenex"},
  { key: "key_90", fr: "Réalisation d’une nouvelle gamme de produits Kleenex et campagne complète sur deux périodes différentes de l’année à destination de deux publics cibles très différents: une gamme pour la rentrée destinée aux enfants et une gamme été familiale qui parle à petits et grands. Ce projet a été présenté devant un jury professionnel dans le cadre de ma scolarité à Garti.", en: "Development of a new range of products and a complete campaign for two different periods in the year and two distinct target audiences: a back-to-school range for children and a summer family range targetting both young and old. This project was introduced to a professional jury as part of my studies at Garti."},
  { key: "key_91", fr: "Swaroski", en: "Swaroski"},
  { key: "key_92", fr: "Projet de groupe consistant à réaliser deux axes de communication pour de l’ouverture d’un concept store autour des strass dentaires Swarovski. Création d’une charte graphique pour chaque axe, photographie de mannequins en studio, mise en page des affiches, mise en situation pour les deux axes et campagne sur les réseaux sociaux pour un axe choisi. Ce projet a été présenté devant un jury professionnel dans le cadre de ma scolarité à Garti.", en: "Group project including two campaigns for the opening of a concept store featuring Swarovski dental rhinestones. Development of a graphic charter for each approach, studio photography of models, poster layout, product placements for both approaches, and a social media campaign for a selected approach. This project was introduced to a professional jury as part of my studies at Garti."},
  { key: "key_93", fr: "Pierre", en: "Stones"},
  { key: "key_94", fr: "Étude photographique de la pierre dans la ville à travers un traitement graphique traditionnel qui vous invite à une promenade parmi les allées de Montigny-le-Bretonneux.", en: "Photographic study of stones in the city through a traditional graphic treatment that invites viewers to stroll through the alleys of Montigny-le-Bretonneux."},
  { key: "key_95", fr: "Portrait Chinois", en: "Chinese Portrait"},
  { key: "key_96", fr: "Rassembler en une image tout ce qui nous représente, en s’appuyant sur des questions comme: « Si j’étais une plante, que serais-je ? », le tout au sein d’une composition réalisée avec Photoshop.", en: "Picturing my spiritual soul in a single image based on questions such as: “If I were a plant, what would I be?”, all within a composition created using Photoshop."},
  { key: "key_97", fr: "Le printemps renaît toujours", en: "Le printemps renaît toujours" },
  { key: "key_98", fr: "Histoire mêlant deux temps de récit. D’un côté, nous explorons la création du monde selon Jérémy Drava à travers des figures emblématiques de la série The Legend of Zelda délaissée par les jeux, afin d’expliquer la chronologie sous le prisme de ces personnages oubliés. Dans un second temps, on accompagne ce même Jérémy dans son quotidien chez Nintendo, lorsqu'il lutte entre sa vision personnelle de l’univers et celle de sa hiérarchie et qu’il est nommé co- auteur pour le scénario du jeu 'Zelda: Tears of the Kingdom'.", en: "The Legend of Zelda is a story intertwining two timelines. The first one explores the creation of the world according to Jeremy Drava through emblematic figures of the Zelda series who are ignored in the video games. The book highlights the chronology through their perspective. The second timeline visualizes Jeremy struggling between his vision of the universe versus the one of his hierarchy at Nitendo after his promotion as co-author for the script of 'Zelda: Tears of the Kingdom.'" },
  { key: "key_99", fr: "Il suffit de trois tours", en: "Il suffit de trois tours" },
  { key: "key_100", fr: "Proposition d'un titre-logo pour un roman de Luny Asthiers.", en: "Cover proposal for a novel written by Luny Asthiers." },
  { key: "key_101", fr: "Fourth Wing", en: "Fourth Wing" }, 
  { key: "key_102", fr: "Illustration réalisée sur Krita à la demande d’une cliente, incluant deux personnages de la série, deux personnages du monde réel et un décor simple.", en: "Customer order realised with Krita including two characters from the official books combined with two real characters from the real world and a simple background." },
  { key: "key_103", fr: "Le renard améthyste", en: "Le renard améthyste" },
  { key: "key_104", fr: "Proposition de couverture réalisé sur Photoshop pour Luny Asthiers.", en: "Cover proposal designed with Photoshop for Luny Asthiers." },
  { key: "key_105", fr: "Logo Luny ASTHIERS", en: "Logo Luny ASTHIERS" },
  { key: "key_106", fr: "Conception de Aster (le renard) et mise en situation de celui-ci sur Krita pour son logo personnel. Cette création est antérieure à mes études en graphisme.", en: "Aster the Fox has been designed with Krita as a personnal logo for the requester. This job has been completed prior to my graphical design cursus." },
  { key: "key_107", fr: "Wandel", en: "Wandel" },
  { key: "key_108", fr: "Communication illustrée à l’occasion de la sortie du livre en octobre 2024.", en: "Promotion medium for the release of 'Wandel' in October 2024." },
  { key: "key_109", fr: "Hamlet", en: "Hamlet" },
  { key: "key_110", fr: "Mise en avant d’une citation de la pièce à l'aide d'une mise en page sur Canva.", en: "Highlighting a quote from 'Hamlet' using a layout on Canva." },
  { key: "key_111", fr: "Harry Potter", en: "Harry Potter" },
  { key: "key_112", fr: "Mise en avant d’une citation de Harry Potter à l’école des sorciers avec des visuels sur Canva.", en: "Highlighting a quote from 'Harry Potter and the Sorcerer’s Stone' with visuals on Canva." },
  { key: "key_113", fr: "Guide InDesign 2024", en: "InDesign 2024 Guide" },
  { key: "key_114", fr: "'Le Petit Guide du Stagiaire' fut mon cadeau de départ à la Mairie de Montigny-le-Bretonneux, afin d'aider les futurs stagiaires à utiliser les fonctionnalités avancées du logiciel InDesign comme l'indexation automatique dans l'idée de préserver la structure remaniée et optimisée du guide.", en: "'The Little Intern’s Guide' was my farewell gift to the Montigny-le-Bretonneux City Hall for describing the advanced features of InDesign such as automatic indexing—with the goal of preserving the restructured and optimized layout of the guide." },
  ...
  { key: "key_131", fr: "Quelque chose mais pas tant que ça", en: "Something yet not so much" },
  ...
  { key: "key_139", fr: "Le Monde d’Abhosia", en: "The World of Abhosia" },
