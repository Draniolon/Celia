...
const translationsList = [
  ...
  { key: "key_22", fr: "Communication illustree à l'occasion de la sortie de Wandel en octobre 2024.", en: "Illustrated communication for the release of Wandel in October 2024." },
  ...
  { key: "key_86", fr: "Création d’une marque fille de cannettes issue de la marque mère Smile, création d’une charte graphique et conception de différents modèles de cannette autour de parfums : deux canettes de la gamme permanente et une édition collector à l’aide de Photoshop, Illustrator, Krita et InDesign.", en: "Creation of a sub-brand of cans derived from the parent brand Smile, development of a graphic charter, and design of various can models based on different flavors: two cans for the permanent range and a collector’s edition using Photoshop, Illustrator, Krita, and InDesign." },
  ...
  { key: "key_90", fr: "Réalisation d’une nouvelle gamme de produits Kleenex et campagne complète sur deux périodes différentes de l’année à destination de deux publics cibles très différents: une gamme pour la rentrée destinée aux enfants et une gamme été familiale qui parle à petits et grands. Ce projet a été présenté devant un jury professionnel dans le cadre de ma scolarité à Garti.", en: "Development of a new range of Kleenex products and a complete campaign for two different periods of the year and two distinct target audiences: a back-to-school range for children and a summer family range appealing to both young and old. This project was presented before a professional jury as part of my studies at Garti."},
  { key: "key_91", fr: "Swaroski", en: "Swaroski"},
  { key: "key_92", fr: "Projet de groupe consistant à réaliser deux axes de communication pour de l’ouverture d’un concept store autour des strass dentaires Swarovski. Création d’une charte graphique pour chaque axe, photographie de mannequins en studio, mise en page des affiches, mise en situation pour les deux axes et campagne sur les réseaux sociaux pour un axe choisi. Ce projet a été présenté devant un jury professionnel dans le cadre de ma scolarité à Garti.", en: "Group project consisting of creating two campaign approaches for the opening of a concept store featuring Swarovski dental rhinestones. Development of a graphic charter for each approach, studio photography of models, poster layout, product placements for both approaches, and a social media campaign for a selected approach. This project was presented before a professional jury as part of my studies at Garti."},
  ...
  { key: "key_100", fr: "Proposition d'un titre-logo pour un roman de Luny Asthiers.", en: "Customized title proposition for one novel written by Luny Asthiers." },
  ...
  { key: "key_108", fr: "Communication illustrée pour l’occasion de la sortie du livre 'Wandel' en octobre 2024.", en: "Illustrated communication for the release of 'Wandel' in October 2024." },
  { key: "key_109", fr: "Hamlet", en: "Hamlet" },
  { key: "key_110", fr: "Mise en avant d’une citation de la pièce à l'aide d'une mise en page sur Canva.", en: "Highlighting a quote from 'Hamlet' using an layout on Canva." },
